...
export default function SignupPage() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center relative overflow-hidden px-6 bg-[#0f0f11] py-12">
            ...
            <div className="w-full max-w-[420px] animate-fade-in relative z-10 mt-12 md:mt-0">
                <Card variant="glass" className="border-purple-500/20 shadow-[0_0_40px_rgba(139,92,246,0.1)]">
                    <CardContent className="p-8 space-y-8">
                        {/* Header */}
                        <div className="text-center space-y-2">
                            <h1 className="text-3xl font-bold text-white tracking-tight" style={{ fontFamily: '"Creepster", cursive, sans-serif' }}>Join the Coven</h1>
                            <p className="text-sm text-gray-400">Create an account to banish report errors</p>
                        </div>
                        ...
                        <div className="relative flex items-center py-2">
                            ...
                            <span className="flex-shrink-0 mx-4 text-gray-500 text-xs tracking-wider uppercase">Or sign up with email</span>
                            <div className="flex-grow border-t border-white/10"></div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2 relative group">
                                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 group-focus-within:text-purple-400 transition-colors z-10" />
                                    <input
                                        name="password"
                                        type="password"
                                        placeholder="Password"
                                        className="w-full pl-9 pr-3 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 text-white placeholder:text-gray-500 mt-0 transition-all text-sm input-glow"
                                        required
                                    />
                                </div>
                                <div className="space-y-2 relative group mt-0">
                                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 group-focus-within:text-purple-400 transition-colors z-10" />
                                    <input
                                        name="confirmPassword"
                                        type="password"
                                        placeholder="Confirm"
                                        className="w-full pl-9 pr-3 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 text-white placeholder:text-gray-500 transition-all text-sm input-glow"
                                        required
                                    />
                                </div>
                            </div>
                        ...
                        <div className="text-center text-sm text-gray-400 pt-4">
                            Already summoned?{" "}
                            <Link href="/login" className="text-purple-400 hover:text-pink-400 font-medium transition-colors hover:underline">
                                Return here
                            </Link>
                        </div>
                    </CardContent>
